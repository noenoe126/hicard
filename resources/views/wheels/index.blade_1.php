                ...
                <table class="table table-bordered" id="uscdatatable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('wheels.edit', $wheel->id) }}" class="btn btn-info">Edit</a>
                                <form method="post" action="{{ route('wheels.destroy', $wheel->id) }}" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete?');">
                                    @csrf
                                    @method('DELETE')
