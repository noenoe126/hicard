                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="{{ route('models.destroy', $model->id) }}" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete?');">
